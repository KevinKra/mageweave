	...
	return (
		<section className="articles-section">
			...
			<article className="article-link">
				<header>
					<h4 className="article-title">Lets Build an API in Rails</h4>
				</header>
				<body>
					<p>Build an API in Rails and connect your database to the world.</p>
				</body>
				...
				<aside className="bookmark-container">
					<FontAwesomeIcon className="icon" icon={faBookmark} size="lg" transform="down" />
				</aside>
			</article>
		</section>
	);
