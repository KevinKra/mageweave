...
const TopicBadge = ({ type, lesson, destination, history }) => {
	...
	switch (type) {
		...
		case 'practice':
			return (
				<div
					className="practice-badge badge"
					onClick={() => handleClick(destination)}
				>
		...
		case 'challenge':
			return (
				<div
					className="challenge-badge badge"
					onClick={() => handleClick(destination)}
				>
